// adapted from https://github.com/foxglove/ws-protocol/blob/main/cpp/foxglove-websocket/include/foxglove/websocket/server.hpp
// need libasio-dev libwebsocketpp-dev nlohmann-json3-dev
#pragma once
...
public:
  ...
  void sendMessage(ChannelId chanId, uint64_t timestamp, const std::string& data);
...
inline void Server::sendMessage(ChannelId chanId, uint64_t timestamp, const std::string& data) {
